...
# carom:
# ../../../tools/rom.py 0 0x800 11a9a71f.bin dcb77b22.bin 

# romca
# ../../../tools/rom.py 0xc00 0x800 706e035f.bin 47f8b402.bin 799546a7.bin 33f1a400.bin 
...
with open(outname, mode="wb") as outfile:
    for highname, lowname in zip(sys.argv[3::2], sys.argv[4::2]):
